...
TERMUX_PKG_SHA256=fde1aa7b4fbe64ec1b4fc576a57f4688ad1453d2fab59cbadd948a10a6eaf5ef
...
termux_step_configure () {
    "${TERMUX_PKG_SRCDIR}"/configure \
        ...
        -hostdatadir "${TERMUX_PREFIX}/opt/qt/cross" \
